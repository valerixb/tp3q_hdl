...
set_property IOSTANDARD LVDS [get_ports {TP_CMD_DATA_N[0]}]
#set_property PACKAGE_PIN V2       [get_ports "FMC_HPC0_LA02_P"] ;# Bank  66 VCCO - VADJ_FMC - IO_L23P_T3U_N8_66
set_property PACKAGE_PIN V2 [get_ports {TP_CMD_DATA_P[0]}]
set_property PACKAGE_PIN V1 [get_ports {TP_CMD_DATA_N[0]}]
set_property IOSTANDARD LVDS [get_ports {TP_CMD_DATA_P[0]}]
#set_property PACKAGE_PIN Y1       [get_ports "FMC_HPC0_LA03_N"] ;# Bank  66 VCCO - VADJ_FMC - IO_L22N_T3U_N7_DBC_AD0N_66
set_property IOSTANDARD LVDS [get_ports {TP_ENABLE_N[0]}]
#set_property PACKAGE_PIN Y2       [get_ports "FMC_HPC0_LA03_P"] ;# Bank  66 VCCO - VADJ_FMC - IO_L22P_T3U_N6_DBC_AD0P_66
set_property PACKAGE_PIN Y2 [get_ports {TP_ENABLE_P[0]}]
set_property PACKAGE_PIN Y1 [get_ports {TP_ENABLE_N[0]}]
set_property IOSTANDARD LVDS [get_ports {TP_ENABLE_P[0]}]
...
set_property IOSTANDARD LVDS [get_ports {TP_CMD_CLK_N[0]}]
#set_property PACKAGE_PIN Y4       [get_ports "FMC_HPC0_LA00_CC_P"] ;# Bank  66 VCCO - VADJ_FMC - IO_L13P_T2L_N0_GC_QBC_66
set_property PACKAGE_PIN Y4 [get_ports {TP_CMD_CLK_P[0]}]
set_property PACKAGE_PIN Y3 [get_ports {TP_CMD_CLK_N[0]}]
set_property IOSTANDARD LVDS [get_ports {TP_CMD_CLK_P[0]}]
set_property IOSTANDARD LVDS [get_ports {FMC_HPC0_CLK0_M2C_N[0]}]
set_property PACKAGE_PIN AA7 [get_ports {FMC_HPC0_CLK0_M2C_P[0]}]
set_property PACKAGE_PIN AA6 [get_ports {FMC_HPC0_CLK0_M2C_N[0]}]
set_property IOSTANDARD LVDS [get_ports {FMC_HPC0_CLK0_M2C_P[0]}]
...
#set_property IOSTANDARD LVDS [get_ports {FMC_HPC1_CLK0_M2C_N[0]}]
#set_property PACKAGE_PIN AE7 [get_ports {FMC_HPC1_CLK0_M2C_P[0]}]
#set_property PACKAGE_PIN AF7 [get_ports {FMC_HPC1_CLK0_M2C_N[0]}]
#set_property IOSTANDARD LVDS [get_ports {FMC_HPC1_CLK0_M2C_P[0]}]
...
set_property IOSTANDARD DIFF_SSTL12 [get_ports {USER_SI570_N[0]}]
set_property PACKAGE_PIN AL8 [get_ports {USER_SI570_P[0]}]
set_property PACKAGE_PIN AL7 [get_ports {USER_SI570_N[0]}]
set_property IOSTANDARD DIFF_SSTL12 [get_ports {USER_SI570_P[0]}]
